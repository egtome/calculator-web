<div id="multiplication-operation" style="margin-left: 20px; margin-top: 7%; text-align:center;">
  <h4 class="mb-3">Multiplication Operation - Cost: <?= $params['operation_cost'] ?></h4>
  <form class="needs-validation" novalidate method="POST" onsubmit="return validateForm()">
      ...
      <br /><i class="fa fa-times" style="display: inline !important;" ></i><br /><br />      
      <div>
